...
TECH_DATABASE = [
    {
        "title": "智能光纤传感器在结构健康监测中的应用",
        "desc": "本成果提出了一种基于智能光纤传感的新型结构健康监测方法。",
        "status": "已部署试点项目",
        "field": "结构健康监测、土木工程、光纤传感",
        "summary": "适用于桥梁、高铁、航空等关键结构的状态实时监测。",
        "TRL": 6,
        "industry": "新能源、智能制造",
        "innovation": "高",
        "commercial": "中",
    ...
    {
        "title": "船舶与海洋装备耐波性系列模拟软件",
        "desc": "快速模拟各类船舶在波浪中运动的性能，技术成熟，自主可控。",
        "status": "样品阶段",
        "field": "船舶设计、海洋装备设计",
        "summary": "适用于桥梁、高铁、航空等关键结构的状态实时监测。",
        "TRL": 7,
    ...
    {
        "title": "船舶与海洋平台运动姿态在线监测分析与实时预报系统",
        "desc": "支持舰载机回收、救生船布放等多场景，已完成实船海试，效果良好。",
        "status": "具有样机，技术成熟",
        "field": "舰载作业、平台控制",
        "summary": "提供舰载控制辅助决策支持，预报准确，实用性强。",
        "TRL": 8,
        "industry": "智能控制、海上作业",
        "innovation": "高",
        "commercial": "高",
    ...
    {
        "title": "基于运动预报的船舶纵-横联合减摇控制技术",
        "desc": "可联合控制横摇与纵摇，已完成样机并在拖曳水池测试。",
        "status": "样品阶段",
        "field": "减摇系统、舰船控制",
        "summary": "基于水动力预报模型实现动态联合减摇，适用于恶劣海况作业。",
        "TRL": 6,
        "industry": "船舶动力与减摇",
        "innovation": "中",
        "commercial": "中",
    ...
    {
        "title": "深水浮式结构物运动耦合及外载荷分析研究",
        "desc": "填补国内软件空白，拥有自主产权，支持平台运动与载荷分析。",
        "status": "开发完成，待推广",
        "field": "深海工程、载荷分析",
        "summary": "支持浮式平台三维响应分析，满足国产化设计需求。",
        "TRL": 5,
        "industry": "深海工程设计",
        "innovation": "高",
        "commercial": "中",
    ...
    {
        "title": "高速船耐波性计算软件",
        "desc": "适用于弗氏数大于0.4的多体高速船，计算效率高。",
        "status": "技术成熟",
        "field": "高速船、波浪载荷分析",
        "summary": "可快速评估高速船耐波性，适用于多体高速船快速设计阶段。",
        "TRL": 7,
        "industry": "船舶动力分析",
        "innovation": "中",
        "commercial": "高",
    ...
    {
        "title": "内燃机燃料喷射特性测试与分析系统",
        "desc": "支持氨/氢等清洁燃料喷射特性测试，已有多型产品应用。",
        "status": "成熟产品阶段",
        "field": "发动机燃料供给系统",
        "summary": "提供高精度流量分析与喷雾形态检测，打破国外垄断。",
        "TRL": 9,
        "industry": "能源动力系统、发动机检测",
        "innovation": "高",
        "commercial": "高",
        "university": "哈尔滨工程大学",
        "school": "动力与能源学院",
...
if page == "📄 成果详情页":
    ...
    st.subheader("📊 成果数据概览")
    df = pd.DataFrame(TECH_DATABASE)
    df["转化潜力评分"] = df.apply(lambda row: (row['TRL'] + {'高': 3, '中': 2, '低': 1}[row['innovation']] + {'高': 3, '中': 2, '低': 1}[row['commercial']]) / 3, axis=1)
    st.dataframe(df[["title", "TRL", "innovation", "commercial", "转化潜力评分"]])
    st.download_button("📥 导出成果数据", data=df.to_csv(index=False), file_name="tech_data.csv")
    ...
    col1.metric("上传成果数", "128")
    col2.metric("企业项目数", "53")
    col3.metric("活跃用户数", "41")

    st.markdown("#### 🧾 最近上传成果")
    df_teachers = pd.DataFrame([
        {"教师": "张教授", "成果名": "智能传感系统", "上传时间": "2025-06-18"},
        {"教师": "刘教授", "成果名": "碳材料电池", "上传时间": "2025-06-17"}
    ])
